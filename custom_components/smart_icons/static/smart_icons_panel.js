...
`);for(let i=0;i<t.length;i++)if(r.test(t[i]))return i+1}var Oo=0;function W(){return Oo++}var Lo=[{value:"",label:"(else)"},{value:"lt",label:"< Less than"},{value:"lte",label:"\u2264 Less than or equal"},{value:"gt",label:"> Greater than"},{value:"gte",label:"\u2265 Greater than or equal"},{value:"eq",label:"= Equal to"}],M=class extends O{constructor(){super(...arguments);this.errorMessage="";this.working=this.blankState();this.codeMode=!1;this.codeText="";this.codeError="";this.observedStates=[];this._observedStatesCache=new Map;this._observedStatesEntityId="";this.toggleCodeView=()=>{if(this.codeMode){let{rules:t,parseError:i}=fe(this.codeText);if(i){this.codeError=i;return}let n=t[0];if(!n){this.codeError="YAML did not contain a rule.";return}this.working=this.hydrate(this.partialToRule(n)),this.codeMode=!1,this.codeError=""}else{let t=this.serialize();this.codeText=Ur(this.partialToRule(t)),this.codeError="",this.codeMode=!0}};this.cancelClicked=()=>{this.dispatchEvent(new CustomEvent("cancel",{bubbles:!0,composed:!0}))};this.onThresholdMoved=t=>{t.stopPropagation();let{oldIndex:i,newIndex:n}=t.detail;if(i===n||i<0||n<0||i>=this.working.thresholds.length||n>=this.working.thresholds.length)return;let o=[...this.working.thresholds],[s]=o.splice(i,1);o.splice(n,0,s),this.working={...this.working,thresholds:o}};this.addGlob=()=>{this.working={...this.working,targetGlobs:[...this.working.targetGlobs,{value:"",_key:W()}]}};this.addThreshold=()=>{this.working={...this.working,thresholds:[...this.working.thresholds,{lt:0,color:"",background_color:"",icon:"",_key:W()}]}};this.addMapping=()=>{this.working={...this.working,mapping:[...this.working.mapping,{key:"",color:"",background_color:"",icon:"",_key:W()}]}};this.save=()=>{let t;if(this.codeMode){let{rules:i,parseError:n}=fe(this.codeText);if(n){this.codeError=n;return}let o=i[0];if(!o){this.codeError="YAML did not contain a rule.";return}t=o,this.working.id&&(t.id=this.working.id)}else t=this.serialize();this.dispatchEvent(new CustomEvent("save",{detail:t,bubbles:!0,composed:!0}))}}connectedCallback(){super.connectedCallback();for(let t of["ha-icon-picker","ha-selector","ha-input","ha-button","ha-switch","ha-sortable","ha-icon","ha-code-editor"])customElements.get(t)||customElements.whenDefined(t).then(()=>this.requestUpdate()).catch(()=>{})}willUpdate(t){t.has("rule")&&(this.working=this.rule?this.hydrate(this.rule):this.blankState());let i=this.observedSourceForAutocomplete();i!==this._observedStatesEntityId&&(this._observedStatesEntityId=i,this.refreshObservedStates(i))}observedSourceForAutocomplete(){let t=this.working.source.trim();return t||this.working.targetEntities[0]||""}async refreshObservedStates(t){if(!t||!this.hass){this.observedStates=[];return}let i=this._observedStatesCache.get(t);if(i){this.observedStates=i;return}let n=this.hass.states[t]?.state;n&&(this.observedStates=[n]);let o=new Set;n&&o.add(n);try{let a=new Date,l=new Date(a.getTime()-10080*60*1e3),u=(await this.hass.connection.sendMessagePromise({type:"history/history_during_period",start_time:l.toISOString(),end_time:a.toISOString(),entity_ids:[t],minimal_response:!0,no_attributes:!0}))?.[t];if(Array.isArray(u))for(let d of u){let h=d.s??d.state;typeof h=="string"&&h&&o.add(h)}}catch{}if(t!==this._observedStatesEntityId)return;let s=[...o].sort();this._observedStatesCache.set(t,s),this.observedStates=s}renderIconField(t,i){return customElements.get("ha-icon-picker")&&this.hass?g`
    ...
    `}renderModeSelector(){let t=[{value:"mapping",label:"Mapping (exact state \u2192 decoration)"},{value:"thresholds",label:"Thresholds (numeric ranges)"}];return g`
      <ha-selector
        .hass=${this.hass}
    ...
    `}renderMapping(){let t=this.working.mapping,i=t.every(n=>!n.key.trim());return g`
      <fieldset>
        <legend>
    ...
    `}renderColorInput(t,i,n="Color"){return g`
...
`),a=0;for(let c=0;c<o.start;c++)a+=s[c].length+1;let l=a;for(let c=o.start;c<o.end;c++)l+=s[c].length+1;l=Math.min(l,i.text.length),i.view.focus(),i.view.dispatch({selection:{anchor:a,head:l},scrollIntoView:!0})}jumpToLine(t,i){let n=this.resolveCmView();if(!n)return;let o=n.text.split(`
`);if(t<1||t>o.length)return;let s=t-1,a=0;for(let u=0;u<s;u++)a+=o[u].length+1;let l=a+o[s].length,c=this.lineColToOffset(n.text,t,i);n.view.focus(),i&&c!==null?n.view.dispatch({selection:{anchor:c},scrollIntoView:!0}):n.view.dispatch({selection:{anchor:a,head:l},scrollIntoView:!0})}renderDeleteConfirm(){let t=this.pendingDelete,i=t.targets.length===1?t.targets[0]:`${t.targets.length} targets (${t.targets[0]}\u2026)`;return g`
      <ha-dialog
        open
        heading="Delete rule?"
    ...
    `}autoJumpToFirstError(){let t=this.codeError;if(!t)return;if(t.ruleErrors&&t.ruleErrors.length>0){this.jumpToRule(t.ruleErrors[0].index);return}let i=this.jumpHandlerFor(t);i&&i()}errorMessage(t){if(t&&typeof t=="object"&&"message"in t){let i=t.message;if(typeof i=="string")return i}return String(t)}};$.styles=Ft,y([N({attribute:!1})],$.prototype,"hass",2),y([N({type:Boolean,reflect:!0})],$.prototype,"narrow",2),y([_()],$.prototype,"rules",2),y([_()],$.prototype,"editing",2),y([_()],$.prototype,"dialogOpen",2),y([_()],$.prototype,"editorError",2),y([_()],$.prototype,"pendingDelete",2),y([_()],$.prototype,"actionError",2),y([_()],$.prototype,"codeMode",2),y([_()],$.prototype,"codeText",2),y([_()],$.prototype,"codeInitialText",2),y([_()],$.prototype,"codeError",2),y([_()],$.prototype,"codeSubmitting",2),y([_()],$.prototype,"pendingDiscard",2),$=y([ke("smart-icons-panel")],$);
